...
# Bot Token
TELEGRAM_BOT_TOKEN = '8196318397:AAFf1dat6dpZCngoMR5oLJ02GZ4yVPYiA3A'
ADMIN_ID = 8138483951
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "💼 Welcome to Autonix ! To get our trading key, you need to pay $30 USD through one of the methods below.\n\nChoose your payment method:",
...
def start_basickey_bot():
    print("Starting the lite key bot...")
