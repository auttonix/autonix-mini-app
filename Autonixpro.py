...
TELEGRAM_BOT_TOKEN = '8121538189:AAGfMEFiIXDixAIMItXokPrJ_bnNdYBJnhA'

TRADING_KEY = "laTf183B9B3733C58BdAC15Df"

LOG_FILE = "user_activitypremium.xlsx"
...
async def handle_terms_agreement(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if query.data == "agree_terms":
        ...
        await query.edit_message_text(
           ...
           "\U0001F680 Welcome to Autonix' Pro Trading Bot! \U0001F680\n\n"
           "Your trading journey is about to be revolutionized to the next level beyond your imaginations! \U0001F4C8\n"
           "This bot analyzes market trends and *tick history* in real-time and only places trades when the conditions of a profitable trade are met to help you win big!\n\n"
    ...
    if next_step == "api_token":
        ...
        async with websockets.connect(WEBSOCKET_URL) as websocket:
            ...
            await update.message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("I don't have a trading key", url="https://t.me/autonix_pro_key_bot")]])
            )
...
def start_premium_bot():
    print("Starting the pro bot...")
